    ...
    <div className="flex justify-center items-center my-10">
      <div className="flex flex-col text-center">
        ...
        <div className="flex flex-col md:flex-row space-y-10 md:space-x-10 md:space-y-0 mt-10 items-center">
          <Feature title="Hight Quality Music" description="Music lovers can enjoy Siesta's music system. Complete with powerful commands. You will never need another music bot again! " />
