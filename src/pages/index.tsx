...
const Home: NextPage = () => {
  return (
    <div className="w-full">
      ...
      <NavBar />
      <div className="bg-[#3d3e51] h-1 mt-3"></div>
      <div className="my-20 flex flex-col md:flex-row items-center justify-center">
        <Image src="/siesta.jpeg" width="350px" height="350px" className="rounded-full shadow-md" />
        <div className="flex flex-col">
          <h1 className="font-semibold md:ml-20 text-center text-6xl">
            Its time to invite <strong>Siesta</strong>!
          </h1>
          <div className="text-3xl font-light md:ml-20 text-center pt-5">
            <p>
